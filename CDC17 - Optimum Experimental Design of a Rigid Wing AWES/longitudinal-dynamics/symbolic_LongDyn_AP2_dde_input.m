function [ode,states,controls,theta] = symbolic_LongDyn_AP2_dde_input
  import casadi.*
  % x(1) = vt;   % airspeed        [m/s]
  ...
  g0 = -9.8066;
  rhs = [a11*x1 + a12*x2 + g0*x3 + a14*x4 + b1*x5;
         a21*x1 + a22*x2         + a24*x4 + b2*x5;
                                   1.0*x4;
         a41*x1 + a42*x2         + a44*x4 + b4*x5;
         u];
